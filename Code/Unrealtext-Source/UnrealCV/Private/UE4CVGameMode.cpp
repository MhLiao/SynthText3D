...
AUE4CVGameMode::AUE4CVGameMode()
{
	...
	//GEngine->AddOnScreenDebugMessage(-1, 5.0f, FColor::Red, TEXT("hello UNrealCV Game Mode."));
}
...
{
	Super::BeginPlay();
	//GEngine->AddOnScreenDebugMessage(-1, 5.0f, FColor::Red, TEXT("We are using UE4Character."));
}
...
void AUE4CVPawn::BeginPlay()
{
	...
	//GEngine->AddOnScreenDebugMessage(-1, 5.0f, FColor::Red, TEXT("We are using UE4Pawn."));
}
...
void AUE4CVPawn::OnFire()
{
	...
	//
	FILE* info_file = fopen("camera_trajectory2.txt","a");
